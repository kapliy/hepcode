...
\only<2>{\footnotesize{Acceptance for $p_T>25 \GeV$ (wrt $p_T>20 \GeV$) }}
\colb[T]
\column{.5\textwidth}
\centering
...
\only<1>{\footnotesize{BEFORE: Some systematics are hidden under the 0\% line }}
\only<2>{\footnotesize{AFTER:  All systematics are present because $|abs|$ was added }}
}
...
%===========================================
\input{dates/20121119/trigger}

%===========================================
%  Studying choice of tau Monte-Carlo
%===========================================
\input{dates/20121119/wtaunu}

%===========================================
%  QCD closure tests - new problems
%===========================================
\input{dates/20121119/qcdclosure}
...
{
\centering
Decided to use all truth-level weights to compute nevents.
}
