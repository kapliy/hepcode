...
\iteb
\item Somehow, requiring the probe muon to match to an EF trigger for muons around the dip \red{at the ntuple level} does not actually imply that this muon triggered?
