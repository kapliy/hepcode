import ROOT
from ROOT import RooWorkspace,kTRUE,kDashed,RooArgSet
...
#data = w.pdf('sum').generate(RooArgSet(w.obj('mes')),2000)
...
w.pdf('sum').plotOn(mesframe,RF.Components(w.set('argset')),RF.LineStyle(kDashed))
mesframe.Draw()
