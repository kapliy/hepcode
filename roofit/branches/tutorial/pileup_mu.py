...
#fnames='/share/ftkdata/antonk/DATA/v1_26/user.ponyisi.mc11_7TeV.106047.PythiaZmumu_no_filter.merge.AOD.e815_s1272_s1274_r2730_r2700_tid519073_00.ntuple.v1_27.111001003118/user.ponyisi.*.flatntuple.*.root'

fout = ROOT.TFile.Open('mu_mc11.root','RECREATE')

t = ROOT.TChain('tree','tree')
itot=0
flb = glob.glob(fnames)
[t.Add(f) for f in flb]
print 'Added',len(flb),'files'

if re.search('/share/ftkdata/antonk/DATA/v1_26/',flb[0]):
    print 'Will use [lumi_mu_average]...'
    #t.Draw('lumi_mu_average>>mu_mc11(21,-0.5,20.5)','','goff')
    t.Draw('lumi_mu_actual>>mu_mc11(21,-0.5,20.5)','','goff')
else:
    print 'Will use [lb]...'
