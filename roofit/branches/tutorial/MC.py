...
mc09.append(MCR(106044,'mc2_wmunu','*',8894.06*1.17/1000,1.000000,6993798))
mc09.append(MCR(106022,'mc2_wtaunu','*',8916.33*1.17/1000,0.87867,999874))
mc09.append(MCR(106047,'mc2_zmumu','*',851.011*1.15/1000,1.000000,4998410))
mc09.append(MCR(106052,'mc2_ztautau','*',856.967*1.15/1000,1.000000,1998598))
mc09.append(MCR(105861,'mc2_ttbar','*',1.4580E-1,0.54301,199838))
# these are incorrect:
mc09.append(MCR(113204,'mc2_J0','*',9.6139E+06,1.0,500000))
mc09.append(MCR(113205,'mc2_J1','*',7.4366E+05,1.0,500000))
mc09.append(MCR(113206,'mc2_J2','*',4.4307E+04,1.0,500000))
mc09.append(MCR(113207,'mc2_J3','*',2.3576E+03,1.0,500000))
mc09.append(MCR(113208,'mc2_J4','*',9.4236E+01,1.0,500000))
mc09.append(MCR(113209,'mc2_J5','*',2.5813E+00,1.0,500000))
mc09.append(MCR(113210,'mc2_J6','*',3.9439E-02,1.0,500000))
#from here: http://cdsweb.cern.ch/record/1282370/files/ATL-CAL-PROC-2010-001.pdf?version=3
mc09.append(MCR(108405,'mc2_bbmu15x','*',7.39E+04/1000,1.0,500000)) 
mc09.append(MCR(106059,'mc2_ccmu15x','*',2.84E+04/1000,1.0,500000))
