...
staco_data0="--root0 '/share/ftkdata1/antonk/ana_v27_1118_newpu_stacoCB_noscale/data_period*/root*.root'"
...
muid_data0="--root0 '/share/ftkdata1/antonk/ana_v27_1118_newpu_muidCB_noscale/data_period*/root*.root'"
muid_data1kpkm="--root1 '/share/ftkdata1/antonk/ana_v27_1118_newpu_muidCB_scaleDATA_kpkm/data_period*/root*.root'"
muid_data1KC="--root1 '/share/ftkdata1/antonk/ana_v27_1118_newpu_muidCB_scaleDATA_KC/data_period*/root*.root'"

staco_mcnoscale0="--root0 '/share/ftkdata1/antonk/ana_v27_1118_newpu_stacoCB_noscale/mc_zmumu/mc_zmumu.root'"
staco_mcdefault1="--root1 '/share/ftkdata1/antonk/ana_v27_1118_newpu_stacoCB_scaleMC_default/mc_zmumu/mc_zmumu.root'"
staco_mckpkm1="--root1 '/share/ftkdata1/antonk/ana_v27_1118_newpu_stacoCB_scaleMC_kpkm/mc_zmumu/mc_zmumu.root'"
staco_mcKC1="--root1 '/share/ftkdata1/antonk/ana_v27_1118_newpu_stacoCB_scaleMC_KC/mc_zmumu/mc_zmumu.root'"
...
if [ "1" -eq "1" ]; then
    ...
    ((i++))
    gput tags $i muid_data_kpkm     "${muid_data0} ${muid_data1kpkm} --zmin 80 --zmax 100"
    ((i++))
    gput tags $i muid_data_KC       "${muid_data0} ${muid_data1KC} --zmin 80 --zmax 100"
    ((i++))
