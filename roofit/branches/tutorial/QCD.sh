...
./stack2.py --input ${input} --qcd 1.0 -b --var "met" --bin "200,0,200" -o TEST -t ETABIN_${i} --preNN="${preNN}" --preNQ="${preNQ}" --preFN="${preFN}" --preFQ="${preFQ}" --cut "mcw*puw*effw*trigw*wptw" -m qcdfit --bgsig 5 --bgewk 5 --bgqcd 3
for i in {0..10}; do
    break
    ./stack2.py --input ${input} --qcd 1.0 -b --var "met" --bin "200,0,200" -o TEST -t ETABIN_${i} --preNN="${preNN}" --preNQ="${preNQ}" --preFN="${preFN}" --preFQ="${preFQ}" --cut "mcw*puw*effw*trigw*wptw" -m qcdfit --bgsig 2 --bgewk 5 --bgqcd 3 --extra ${i} &> LOG.${i} &
done
