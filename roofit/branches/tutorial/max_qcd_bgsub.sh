...
# MAIN PLOTTER
./stack2.py -q 0 --refline 0.85,1.15 --input ${input} --qcd 1.0 -b --var "fabs(l_eta)" --bin 10,0.0,2.5 --hsource "lepton_etav" -o TEST -t TEST -m qcd_bgsub --bgsig 5 --bgewk 5 --bgqcd 3 #--metallsys
