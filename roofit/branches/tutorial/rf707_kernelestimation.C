...
void rf707_kernelestimation()
{
  ...
  RooNDKeysPdf ndest1("ndest1","ndest1",RooArgSet(x),*data1,"am");
  RooNDKeysPdf ndest2("ndest1","ndest1",RooArgSet(xf),*data1,"am");
