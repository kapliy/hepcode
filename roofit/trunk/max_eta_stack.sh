...
# NTUPLE PLOTTER
./stack2.py --refline 0.85,1.15 --input ${input} -b --var "l_eta" --bin 100,-2.5,2.5 --hsource "lepton_etav" --cut "mcw*puw*wzptw*vxw*ls1w*ls2w*effw*isow*trigw" -o TEST -t NT -m one_plot_nt --bgsig 5 --bgewk 5 --bgqcd 0 &> LOG.ETA.${i} &
((i++))
./stack2.py --refline 0.85,1.15 --input ${input} -b --var "l_phi" --hsource "l_phi" --bin 30,-3.15,3.15 --cut "mcw*puw*wzptw*vxw*ls1w*ls2w*effw*isow*trigw" -o TEST -t NT -m one_plot_nt --bgsig 5 --bgewk 5 --bgqcd 0 &> LOG.ETA.${i} &
((i++))
./stack2.py --refline 0.85,1.15 --input ${input} -b --var "l_pt" --hsource "l_pt" --bin 40,0,200 --cut "mcw*puw*wzptw*vxw*ls1w*ls2w*effw*isow*trigw" -o TEST -t NT -m one_plot_nt --bgsig 5 --bgewk 5 --bgqcd 0 &> LOG.ETA.${i} &
((i++))


# NTUPLE PLOTTER: STUDYING A BAD BIN
./stack2.py --refline 0.85,1.15 --input ${input} -b --var "l_eta" --bin 100,-2.5,2.5 --hsource "lepton_etav" --cut "mcw*puw*wzptw*vxw*ls1w*ls2w*effw*isow*trigw" -o TEST -t NT_E -m one_plot_nt --bgsig 5 --bgewk 5 --bgqcd 0 --pre "ptiso40/l_pt<0.1 && met>25.0 && l_pt>20.0 && fabs(l_eta)<2.4 && w_mt>40.0 && idhits==1 && fabs(z0)<10.0 && nmuons==1 && l_eta>=-2.18 && l_eta<-1.95" &> LOG.ETA.${i} &
((i++))
./stack2.py --refline 0.85,1.15 --input ${input} -b --var "l_phi" --hsource "l_phi" --bin 30,-3.15,3.15 --cut "mcw*puw*wzptw*vxw*ls1w*ls2w*effw*isow*trigw" -o TEST -t NT_E -m one_plot_nt --bgsig 5 --bgewk 5 --bgqcd 0 --pre "ptiso40/l_pt<0.1 && met>25.0 && l_pt>20.0 && fabs(l_eta)<2.4 && w_mt>40.0 && idhits==1 && fabs(z0)<10.0 && nmuons==1 && l_eta>=-2.18 && l_eta<-1.95" &> LOG.ETA.${i} &
((i++))
./stack2.py --refline 0.85,1.15 --input ${input} -b --var "l_pt" --hsource "l_pt" --bin 40,0,200 --cut "mcw*puw*wzptw*vxw*ls1w*ls2w*effw*isow*trigw" -o TEST -t NT_E -m one_plot_nt --bgsig 5 --bgewk 5 --bgqcd 0 --pre "ptiso40/l_pt<0.1 && met>25.0 && l_pt>20.0 && fabs(l_eta)<2.4 && w_mt>40.0 && idhits==1 && fabs(z0)<10.0 && nmuons==1 && l_eta>=-2.18 && l_eta<-1.95" &> LOG.ETA.${i} &
((i++))
