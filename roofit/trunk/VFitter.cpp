...
//  TFractionFitFCN2
//
//  Computes negative log-likelihood for VFitter
//

void TFractionFitFCN2(Int_t& npar, Double_t* gin, Double_t& f, Double_t* par, Int_t flag);


// @(#)root/hist:$Id: VFitter.cxx 38775 2011-04-08 08:27:27Z moneta $
...
//   mc->Add(mc1);
//   mc->Add(mc2);
//   VFitter* fit = new VFitter(data, mc); // initialise
...
//______________________________________________________________________________
VFitter::VFitter(TH1* data, TObjArray  *MCs, Option_t *option) :
  fFitDone(kFALSE), fFitInfinite(kFALSE), fChisquare(0), fPlot(0)  {
   // VFitter constructor. Does a complete initialisation (including
...
void VFitter::SetData(TH1* data) {
   ...
   //   rather instantiate a new VFitter object)
...
//______________________________________________________________________________
void VFitter::SetMC(Int_t parm, TH1* MC) {
...
//______________________________________________________________________________
void VFitter::SetWeight(Int_t parm, TH1* weight) {
...
//______________________________________________________________________________
TVirtualFitter* VFitter::GetFitter() const {
...
//______________________________________________________________________________
void VFitter::CheckParNo(Int_t parm) const {
...
//______________________________________________________________________________
void VFitter::SetRangeX(Int_t low, Int_t high) {
...
//______________________________________________________________________________
void VFitter::SetRangeY(Int_t low, Int_t high) {
...
//______________________________________________________________________________
void VFitter::SetRangeZ(Int_t low, Int_t high) {
...
//______________________________________________________________________________
void VFitter::ExcludeBin(Int_t bin) {
...
//______________________________________________________________________________
void VFitter::IncludeBin(Int_t bin) {
...
//______________________________________________________________________________
bool VFitter::IsExcluded(Int_t bin) const {
...
//______________________________________________________________________________
void VFitter::Constrain(Int_t parm, Double_t low, Double_t high) {
...
//______________________________________________________________________________
void VFitter::UnConstrain(Int_t parm) {
...
//______________________________________________________________________________
void VFitter::ErrorAnalysis(Double_t UP) {
...
//______________________________________________________________________________
void VFitter::GetResult(Int_t parm, Double_t& value, Double_t& error) const {
...
//______________________________________________________________________________
void VFitter::GetRanges(Int_t& minX, Int_t& maxX, Int_t& minY, Int_t& maxY,
...
//______________________________________________________________________________
void VFitter::ComputeFCN(Int_t& /*npar*/, Double_t* /*gin*/,
...
//______________________________________________________________________________
bool VFitter::FindPrediction(int bin, Double_t *fractions, Double_t &ti, int& k0, Double_t &aki) const {
...
void TFractionFitFCN2(Int_t& npar, Double_t* gin, Double_t& f, Double_t* par, Int_t flag) {
   ...
   // on to the VFitter::ComputeFCN member function.

   VFitter* fitter = dynamic_cast<VFitter*>(fractionFitter->GetObjectFit());
   if (!fitter) {
...
//______________________________________________________________________________
Double_t VFitter::GetChisquare() const
{
...
//______________________________________________________________________________
Double_t VFitter::GetProb() const
{
...
//______________________________________________________________________________
void VFitter::ComputeChisquareLambda()
{
...
//______________________________________________________________________________
TH1* VFitter::GetMCPrediction(Int_t parm) const
{
