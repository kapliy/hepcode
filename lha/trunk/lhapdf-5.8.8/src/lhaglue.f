...
!*********************************************************************
!
! $Id: lhaglue.f 922 2012-06-15 14:24:02Z whalley $
!
! $Log$
...
!...NNPDF  Family second tranche
  ELSEIF((LHAINPUT .GE. 190000) .AND. (LHAINPUT .LE. 210100)) THEN
     ...
     ELSE
        ...
        ENDIF          
!...NNPDF 2.3  Family 
  ELSEIF((LHAINPUT .GE. 229000) .AND. (LHAINPUT .LE. 241300)) THEN
     XMIN = 1.0D-9 
     Q2MIN = 2.0D0 
     Q2MAX = 1.0D08  
     ...
     ELSEIF((LHAINPUT .GE. 237400) .AND. (LHAINPUT .LE. 237500))THEN
     	LHASET = 237400
     	LHANAME=LHAPATH(1:LHAPATHLEN)//'/NNPDF23_nlo_nf4_as_0116.LHgrid'
     ELSEIF((LHAINPUT .GE. 237600) .AND. (LHAINPUT .LE. 237700))THEN
     	LHASET = 237600
     	LHANAME=LHAPATH(1:LHAPATHLEN)//'/NNPDF23_nlo_nf4_as_0117.LHgrid'
     ELSEIF((LHAINPUT .GE. 237800) .AND. (LHAINPUT .LE. 237900))THEN
     	LHASET = 237800
     	LHANAME=LHAPATH(1:LHAPATHLEN)//'/NNPDF23_nlo_nf4_as_0118.LHgrid'
     ELSEIF((LHAINPUT .GE. 238000) .AND. (LHAINPUT .LE. 238100))THEN
     	LHASET = 238000
     	LHANAME=LHAPATH(1:LHAPATHLEN)//'/NNPDF23_nlo_nf4_as_0119.LHgrid'
     ELSEIF((LHAINPUT .GE. 238200) .AND. (LHAINPUT .LE. 238300))THEN
     	LHASET = 238200
     	LHANAME=LHAPATH(1:LHAPATHLEN)//'/NNPDF23_nlo_nf4_as_0120.LHgrid'

     ELSEIF((LHAINPUT .GE. 238400) .AND. (LHAINPUT .LE. 238500))THEN
     	LHASET = 237400
     	LHANAME=LHAPATH(1:LHAPATHLEN)//'/NNPDF23_nnlo_nf4_as_0116.LHgrid'
     ELSEIF((LHAINPUT .GE. 238600) .AND. (LHAINPUT .LE. 238700))THEN
     	LHASET = 237600
     	LHANAME=LHAPATH(1:LHAPATHLEN)//'/NNPDF23_nnlo_nf4_as_0117.LHgrid'
     ELSEIF((LHAINPUT .GE. 238800) .AND. (LHAINPUT .LE. 238900))THEN
     	LHASET = 237800
     	LHANAME=LHAPATH(1:LHAPATHLEN)//'/NNPDF23_nnlo_nf4_as_0118.LHgrid'
     ELSEIF((LHAINPUT .GE. 239000) .AND. (LHAINPUT .LE. 239100))THEN
     	LHASET = 238000
     	LHANAME=LHAPATH(1:LHAPATHLEN)//'/NNPDF23_nnlo_nf4_as_0119.LHgrid'
     ELSEIF((LHAINPUT .GE. 239200) .AND. (LHAINPUT .LE. 239300))THEN
     	LHASET = 238200
     	LHANAME=LHAPATH(1:LHAPATHLEN)//'/NNPDF23_nnlo_nf4_as_0120.LHgrid'

     ELSEIF((LHAINPUT .GE. 239400) .AND. (LHAINPUT .LE. 239500))THEN
     	LHASET = 239400
     	LHANAME=LHAPATH(1:LHAPATHLEN)//'/NNPDF23_nlo_nf5_as_0116.LHgrid'
     ELSEIF((LHAINPUT .GE. 239600) .AND. (LHAINPUT .LE. 239700))THEN
     	LHASET = 239600
     	LHANAME=LHAPATH(1:LHAPATHLEN)//'/NNPDF23_nlo_nf5_as_0117.LHgrid'
     ELSEIF((LHAINPUT .GE. 239800) .AND. (LHAINPUT .LE. 239900))THEN
     	LHASET = 239800
     	LHANAME=LHAPATH(1:LHAPATHLEN)//'/NNPDF23_nlo_nf5_as_0118.LHgrid'
     ELSEIF((LHAINPUT .GE. 240000) .AND. (LHAINPUT .LE. 240100))THEN
     	LHASET = 240000
     	LHANAME=LHAPATH(1:LHAPATHLEN)//'/NNPDF23_nlo_nf5_as_0119.LHgrid'
     ELSEIF((LHAINPUT .GE. 240200) .AND. (LHAINPUT .LE. 240300))THEN
     	LHASET = 240200
     	LHANAME=LHAPATH(1:LHAPATHLEN)//'/NNPDF23_nlo_nf5_as_0120.LHgrid'

     ELSEIF((LHAINPUT .GE. 240400) .AND. (LHAINPUT .LE. 240500))THEN
     	LHASET = 240400
     	LHANAME=LHAPATH(1:LHAPATHLEN)//'/NNPDF23_nnlo_nf5_as_0116.LHgrid'
     ELSEIF((LHAINPUT .GE. 240600) .AND. (LHAINPUT .LE. 240700))THEN
     	LHASET = 240600
     	LHANAME=LHAPATH(1:LHAPATHLEN)//'/NNPDF23_nnlo_nf5_as_0117.LHgrid'
     ELSEIF((LHAINPUT .GE. 240800) .AND. (LHAINPUT .LE. 240900))THEN
     	LHASET = 240800
     	LHANAME=LHAPATH(1:LHAPATHLEN)//'/NNPDF23_nnlo_nf5_as_0118.LHgrid'
     ELSEIF((LHAINPUT .GE. 241000) .AND. (LHAINPUT .LE. 241100))THEN
     	LHASET = 241000
     	LHANAME=LHAPATH(1:LHAPATHLEN)//'/NNPDF23_nnlo_nf5_as_0119.LHgrid'
     ELSEIF((LHAINPUT .GE. 241200) .AND. (LHAINPUT .LE. 241300))THEN
     	LHASET = 241200
     	LHANAME=LHAPATH(1:LHAPATHLEN)//'/NNPDF23_nnlo_nf5_as_0120.LHgrid'
