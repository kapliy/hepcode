...
D3PDPeterTreeV29::D3PDPeterTreeV29(TTree *tree)
{
  Init(tree);
}

D3PDPeterTreeV29::~D3PDPeterTreeV29()
{
  if (!fChain) return;
  // delete fChain->GetCurrentFile();
}

Int_t D3PDPeterTreeV29::GetEntry(Long64_t entry)
{
...
Long64_t D3PDPeterTreeV29::LoadTree(Long64_t entry)
{
...
void D3PDPeterTreeV29::Init(TTree *tree)
{
