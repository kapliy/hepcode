...
if [ $# -eq 0 ]; then
    outfolder="${outfolder}/`date +%Y%m%d`_jettauetmiss"
else
    outfolder="${outfolder}/${1}_jettauetmiss"
fi

for iinput in /share/ftkdata/jwebster/ana_input/v1_50/user.*.data12_8TeV.period*JetTauEtmiss*.in; do
