...
#ifdef WHTreeV13_cxx
WHTreeV13::WHTreeV13(TTree *tree)
  : fChain(0)
{
  Init(tree);
}
...
Int_t WHTreeV13::GetEntry(Long64_t entry)
{
  // Read contents of entry.
  if (!fChain) return 0;
  return fChain->GetEntry(entry);
}
Long64_t WHTreeV13::LoadTree(Long64_t entry)
{
...
void WHTreeV13::Init(TTree *tree)
{
...
void WHTreeV13::Show(Long64_t entry)
{
...
Int_t WHTreeV13::Cut(Long64_t entry)
{
