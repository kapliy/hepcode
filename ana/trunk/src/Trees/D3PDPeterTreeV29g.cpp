...
D3PDPeterTreeV29g::D3PDPeterTreeV29g(TTree *tree)
{
  Init(tree);
}

D3PDPeterTreeV29g::~D3PDPeterTreeV29g()
{
  if (!fChain) return;
  // delete fChain->GetCurrentFile();
}

Int_t D3PDPeterTreeV29g::GetEntry(Long64_t entry)
{
...
Long64_t D3PDPeterTreeV29g::LoadTree(Long64_t entry)
{
...
void D3PDPeterTreeV29g::Init(TTree *tree)
{
  ...
  if(false) { // not available in v29g ntuple!
