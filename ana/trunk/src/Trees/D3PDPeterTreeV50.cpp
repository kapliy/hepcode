...
D3PDPeterTreeV50::D3PDPeterTreeV50(TTree *tree)
{
  Init(tree);
}

D3PDPeterTreeV50::~D3PDPeterTreeV50()
{
  if (!fChain) return;
  // delete fChain->GetCurrentFile();
}

Int_t D3PDPeterTreeV50::GetEntry(Long64_t entry)
{
...
Long64_t D3PDPeterTreeV50::LoadTree(Long64_t entry)
{
...
void D3PDPeterTreeV50::Init(TTree *tree)
{
  ...
  // PDF weights
  if(false) { // [ not available in D3PDPeterTreeV29g.cpp ]
    fChain->SetBranchStatus("lha_*",1);
  }
  // MC event info
  if(true) {
  ...
  if(true) {
    // truth classifier variables (they are unfilled in V29g ntuple anyway)
  ...
  if( fChain->GetBranchStatus("jet_sumpttrk_allpv") ) { fChain->SetBranchAddress("jet_sumpttrk_allpv", jet_sumpttrk_allpv, &b_jet_sumpttrk_allpv); }
  if( fChain->GetBranchStatus("jet_ntrk") ) { fChain->SetBranchAddress("jet_ntrk", jet_ntrk, &b_jet_ntrk); }
  if( fChain->GetBranchStatus("jet_ntrk_allpv") ) { fChain->SetBranchAddress("jet_ntrk_allpv", jet_ntrk_allpv, &b_jet_ntrk_allpv); }
  ...
  if( fChain->GetBranchStatus("jet_width") ) { fChain->SetBranchAddress("jet_width", jet_width, &b_jet_width); }
  if( fChain->GetBranchStatus("jet_trackwidth") ) { fChain->SetBranchAddress("jet_trackwidth", jet_trackwidth, &b_jet_trackwidth); }
  if( fChain->GetBranchStatus("jet_trackwidth_allpv") ) { fChain->SetBranchAddress("jet_trackwidth_allpv", jet_trackwidth_allpv, &b_jet_trackwidth_allpv); }
  if( fChain->GetBranchStatus("jet_tau1") ) { fChain->SetBranchAddress("jet_tau1", jet_tau1, &b_jet_tau1); }
  if( fChain->GetBranchStatus("jet_tau2") ) { fChain->SetBranchAddress("jet_tau2", jet_tau2, &b_jet_tau2); }
  if( fChain->GetBranchStatus("jet_tau3") ) { fChain->SetBranchAddress("jet_tau3", jet_tau3, &b_jet_tau3); }
  if( fChain->GetBranchStatus("jet_split12") ) { fChain->SetBranchAddress("jet_split12", jet_split12, &b_jet_split12); }
  if( fChain->GetBranchStatus("jet_split23") ) { fChain->SetBranchAddress("jet_split23", jet_split23, &b_jet_split23); }
  if( fChain->GetBranchStatus("jet_split34") ) { fChain->SetBranchAddress("jet_split34", jet_split34, &b_jet_split34); }
  if( fChain->GetBranchStatus("jet_zcut12") ) { fChain->SetBranchAddress("jet_zcut12", jet_zcut12, &b_jet_zcut12); }
  if( fChain->GetBranchStatus("jet_zcut23") ) { fChain->SetBranchAddress("jet_zcut23", jet_zcut23, &b_jet_zcut23); }
  if( fChain->GetBranchStatus("jet_zcut34") ) { fChain->SetBranchAddress("jet_zcut34", jet_zcut34, &b_jet_zcut34); }
  if( fChain->GetBranchStatus("jet_statshape0") ) { fChain->SetBranchAddress("jet_statshape0", jet_statshape0, &b_jet_statshape0); }
  if( fChain->GetBranchStatus("jet_statshape1") ) { fChain->SetBranchAddress("jet_statshape1", jet_statshape1, &b_jet_statshape1); }
  if( fChain->GetBranchStatus("jet_statshape2") ) { fChain->SetBranchAddress("jet_statshape2", jet_statshape2, &b_jet_statshape2); }
  if( fChain->GetBranchStatus("jet_statshape5") ) { fChain->SetBranchAddress("jet_statshape5", jet_statshape5, &b_jet_statshape5); }
  if( fChain->GetBranchStatus("jet_statshape8") ) { fChain->SetBranchAddress("jet_statshape8", jet_statshape8, &b_jet_statshape8); }
  if( fChain->GetBranchStatus("jet_dip12") ) { fChain->SetBranchAddress("jet_dip12", jet_dip12, &b_jet_dip12); }
  if( fChain->GetBranchStatus("jet_dip23") ) { fChain->SetBranchAddress("jet_dip23", jet_dip23, &b_jet_dip23); }
  if( fChain->GetBranchStatus("jet_dip13") ) { fChain->SetBranchAddress("jet_dip13", jet_dip13, &b_jet_dip13); }
  if( fChain->GetBranchStatus("jet_dipexcl12") ) { fChain->SetBranchAddress("jet_dipexcl12", jet_dipexcl12, &b_jet_dipexcl12); }
