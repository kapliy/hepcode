...
D3PDPeterTreeV29i::D3PDPeterTreeV29i(TTree *tree)
{
  Init(tree);
}

D3PDPeterTreeV29i::~D3PDPeterTreeV29i()
{
  if (!fChain) return;
  // delete fChain->GetCurrentFile();
}

Int_t D3PDPeterTreeV29i::GetEntry(Long64_t entry)
{
...
Long64_t D3PDPeterTreeV29i::LoadTree(Long64_t entry)
{
...
void D3PDPeterTreeV29i::Init(TTree *tree)
{
  ...
  // PDF weights
  if(false) { //  [ not available in D3PDPeterTreeV29i.cpp ]
  ...
  if(true) {
    // truth classifier variables (they are unfilled in V29i ntuple anyway)
  ...
  if(false) { // not available in v29i ntuple!
    if( fChain->GetBranchStatus("lha_cteq6ll") ) { fChain->SetBranchAddress("lha_cteq6ll", &lha_cteq6ll, &b_lha_cteq6ll); }
    if( fChain->GetBranchStatus("lha_MRSTMCal") ) { fChain->SetBranchAddress("lha_MRSTMCal", &lha_MRSTMCal, &b_lha_MRSTMCal); }
    if( fChain->GetBranchStatus("lha_CT10") ) { fChain->SetBranchAddress("lha_CT10", &lha_CT10, &b_lha_CT10); }
    if( fChain->GetBranchStatus("lha_MSTW2008lo68cl") ) { fChain->SetBranchAddress("lha_MSTW2008lo68cl", &lha_MSTW2008lo68cl, &b_lha_MSTW2008lo68cl); }
    if( fChain->GetBranchStatus("lha_MSTW2008nlo68cl") ) { fChain->SetBranchAddress("lha_MSTW2008nlo68cl", &lha_MSTW2008nlo68cl, &b_lha_MSTW2008nlo68cl); }
    if( fChain->GetBranchStatus("lha_NNPDF21_100") ) { fChain->SetBranchAddress("lha_NNPDF21_100", &lha_NNPDF21_100, &b_lha_NNPDF21_100); }
    if( fChain->GetBranchStatus("lha_HERAPDF10_EIG") ) { fChain->SetBranchAddress("lha_HERAPDF10_EIG", &lha_HERAPDF10_EIG, &b_lha_HERAPDF10_EIG); }
    if( fChain->GetBranchStatus("lha_cteq66") ) { fChain->SetBranchAddress("lha_cteq66", &lha_cteq66, &b_lha_cteq66); }
  }
