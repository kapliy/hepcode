...
#ifndef D3PDPeterTreeV29i_h
#define D3PDPeterTreeV29i_h
...
class
D3PDPeterTreeV29i : public D3PDPeterTreeBase
{
 public:
  enum {
    nele_max = 10000,
 ...
 public:
  ...
  Float_t mcevt_pdf1;
  Float_t mcevt_pdf2;
  // attention: these do NOT exist in V29i ntuples!
  Int_t njpsi;
  ...
  D3PDPeterTreeV29i(TTree *tree=0);
  virtual ~D3PDPeterTreeV29i();
