...
// Fri Jan 11 04:56:42 2013 by ROOT version 5.34/00
// from TTree tree/Muon tree
// found on file: root://xrddc.mwt2.org:1096/pnfs/uchicago.edu/atlaslocalgroupdisk/user/jwebster/mc12_8TeV/user.jwebster.mc12_8TeV.159672.MadgraphPythia6_AUET2BCTEQ6L1_WimpPair_C5_DM200_QCUT80.UCNTUP.e1632_a159_a171_r3549.j.v1_50.121229005150_rev9690/user.jwebster.009498.flatntuple._00001.root
//////////////////////////////////////////////////////////

#ifndef D3PDPeterTreeV50_h
#define D3PDPeterTreeV50_h
...
class
D3PDPeterTreeV50 : public D3PDPeterTreeBase
{
 public:
  enum {
    nele_max = 10000,
 ...
 public :
  ...
  Float_t         jet_sumpttrk_allpv[njet_max];   //[njet]
  Int_t           jet_ntrk[njet_max];   //[njet]
  Int_t           jet_ntrk_allpv[njet_max];   //[njet]
  ...
  Float_t         jet_width[njet_max];   //[njet]
  Float_t         jet_trackwidth[njet_max];   //[njet]
  Float_t         jet_trackwidth_allpv[njet_max];   //[njet]
  Float_t         jet_tau1[njet_max];   //[njet]
  Float_t         jet_tau2[njet_max];   //[njet]
  Float_t         jet_tau3[njet_max];   //[njet]
  Float_t         jet_split12[njet_max];   //[njet]
  Float_t         jet_split23[njet_max];   //[njet]
  Float_t         jet_split34[njet_max];   //[njet]
  Float_t         jet_zcut12[njet_max];   //[njet]
  Float_t         jet_zcut23[njet_max];   //[njet]
  Float_t         jet_zcut34[njet_max];   //[njet]
  Float_t         jet_statshape0[njet_max];   //[njet]
  Float_t         jet_statshape1[njet_max];   //[njet]
  Float_t         jet_statshape2[njet_max];   //[njet]
  Float_t         jet_statshape5[njet_max];   //[njet]
  Float_t         jet_statshape8[njet_max];   //[njet]
  Float_t         jet_dip12[njet_max];   //[njet]
  Float_t         jet_dip23[njet_max];   //[njet]
  Float_t         jet_dip13[njet_max];   //[njet]
  Float_t         jet_dipexcl12[njet_max];   //[njet]
  ...
  TBranch        *b_jet_sumpttrk_allpv;   //!
  TBranch        *b_jet_ntrk;   //!
  TBranch        *b_jet_ntrk_allpv;   //!
  TBranch        *b_jet_jvtxf;   //!
  TBranch        *b_jet_jvf;   //!
  ...
  TBranch        *b_jet_vtx;   //!
  TBranch        *b_jet_width;   //!
  TBranch        *b_jet_trackwidth;   //!
  TBranch        *b_jet_trackwidth_allpv;   //!
  TBranch        *b_jet_tau1;   //!
  TBranch        *b_jet_tau2;   //!
  TBranch        *b_jet_tau3;   //!
  TBranch        *b_jet_split12;   //!
  TBranch        *b_jet_split23;   //!
  TBranch        *b_jet_split34;   //!
  TBranch        *b_jet_zcut12;   //!
  TBranch        *b_jet_zcut23;   //!
  TBranch        *b_jet_zcut34;   //!
  TBranch        *b_jet_statshape0;   //!
  TBranch        *b_jet_statshape1;   //!
  TBranch        *b_jet_statshape2;   //!
  TBranch        *b_jet_statshape5;   //!
  TBranch        *b_jet_statshape8;   //!
  TBranch        *b_jet_dip12;   //!
  TBranch        *b_jet_dip23;   //!
  TBranch        *b_jet_dip13;   //!
  TBranch        *b_jet_dipexcl12;   //!
  ...
  D3PDPeterTreeV50(TTree *tree=0);
  virtual ~D3PDPeterTreeV50();
